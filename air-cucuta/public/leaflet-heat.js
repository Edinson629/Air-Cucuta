...
*/
!(() => {
  var L = window.L // Declare L variable
  var simpleheat = window.simpleheat // Declare simpleheat variable
  L.HeatLayer = (L.Layer ? L.Layer : L.Class).extend({
    ...
    _initCanvas: function () {
      ...
      var i = L.DomUtil.testProp(["transformOrigin", "WebkitTransformOrigin", "msTransformOrigin"])
      t.style[i] = "50% 50%"
    ...
    _animateZoom: function (t) {
      ...
      var a = this._map._getCenterOffset(t.center)._multiplyBy(-i).subtract(this._map._getMapPanePos())
  ...
  L.heatLayer = (t, i) => new L.HeatLayer(t, i)
})()
